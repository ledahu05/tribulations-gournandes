...
const mentionsLegales = props => {
  const img = props.data.mentionsBcg.image.fluid;
  return (
    <Layout location={props.location} title="Mentions légales">
      <div className="index-container">
        <Hero home="true" style={{ display: "block" }} img={img}>         <Blinker /></Hero>
        <Helmet>
          <title>{config.siteTitle}</title>
          <link rel="canonical" href={`${config.siteUrl}`} />
        </Helmet>

        <h2 id="post">Informations légales</h2>
        <h3>1. Présentation du site.</h3>
        <p>
          En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
          confiance dans l'économie numérique, il est précisé aux utilisateurs
          du site{" "}
          <a href="http://https://www.tribulations-gourmandes.fr/">
            https://www.tribulations-gourmandes.fr
          </a>{" "}
          l'identité des différents intervenants dans le cadre de sa réalisation
          et de son suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Alexia Senilhe – – Place Lesdiguières
          <br />
          <strong>Créateur</strong> :{" "}
          <a href="https://www.appliz.fr">Christophe seguinot</a>
          <br />
          <strong>Responsable publication</strong> : Alexia Senilhe –
          tribulations.gourmandes@gmail.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Christophe seguinot –
          christophe.seguinot@gmail.com
          <br />
          <strong>Hébergeur</strong> : Netlify 2325 3rd Street, Suite 215 94107
          San Francisco / USA – Place Lesdiguières
          <br />
          Crédits : <br />
        ...
        <p>
          ...
          décidée par Alexia Senilhe, qui s’efforcera alors de communiquer
        ...
        <p>
          ...
          est mis à jour régulièrement par Alexia Senilhe. De la même façon, les
        ...
        <p>
          Alexia Senilhe s’efforce de fournir sur le site{" "}
          <a href="http://https://www.tribulations-gourmandes.fr/">
            https://www.tribulations-gourmandes.fr
          </a>{" "}
        ...
        <p>
          Alexia Senilhe est propriétaire des droits de propriété intellectuelle
        ...
        <p>
          Alexia Senilhe ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site https://www.tribulations-gourmandes.fr, et résultant soit de
        ...
        <p>
          Alexia Senilhe ne pourra également être tenue responsable des dommages
        ...
        <p>
          ...
          l’espace contact) sont à la disposition des utilisateurs. Alexia
          Senilhe se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, Alexia Senilhe
        ...
        <p>
          {" "}
          En tout état de cause Alexia Senilhe ne collecte des informations
        ...
        <p>
          ...
          rachat de Alexia Senilhe et de ses droits permettrait la transmission
        ...
        <p>
          ...
          mis en place avec l’autorisation de Alexia Senilhe. Cependant, Alexia
          Senilhe n’a pas la possibilité de vérifier le contenu des sites ainsi
...
export const pageQuery = graphql`
  query mentionLegaleQuery {
    mentionsBcg: contentfulHero(page: { eq: "mentions" }) {
      image {
        title
        fluid {
